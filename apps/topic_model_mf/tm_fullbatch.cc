...
int main(int argc, char* argv[]) {
  ...
  Sym doc_word = Sym::Placeholder(DT_FLOAT, {FLAGS_D, FLAGS_V});
  Sym doc_tpc  = Sym::Variable(DT_FLOAT, {FLAGS_D, FLAGS_K}, Sym::UniformNormalizer(FLAGS_K));
  Sym tpc_word = Sym::Variable(DT_FLOAT, {FLAGS_K, FLAGS_V}, Sym::UniformNormalizer(FLAGS_V));
